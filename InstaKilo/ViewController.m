...
@property (nonatomic,strong) NSArray<UIImage*> *skyArray;
@property (nonatomic,strong) NSArray<UIImage*> *otherArray;
...
//        cell.imageView.image = self.imagesArray[indexPath.item];
         cell.imageView.image = [UIImage imageNamed:@"sky1"];
        return cell;
    }
    

    
    else { Pictures *pic = self.imagesArray[indexPath.section][indexPath.row];
